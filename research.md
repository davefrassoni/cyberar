...
- **Comunicaciones resilientes multicanal con degradación y restauración simulada** (RF primario, RF direccional, óptico/láser, satelital y fibra tendida), pensadas para responder al escenario de jamming/interferencia de las secciones 1, 2 y 3. La fibra tendida es el único canal con impacto de interferencia 0 por diseño — es la idea de "comunicación por cable" de la propuesta original de defensa, llevada al simulador como el enlace que ningún jammer RF ni interferencia atmosférica puede degradar, al costo (no modelado aquí) del alcance físico limitado por el cable. El panel RED TEAM expone estos ataques como botones grandes agrupados por vector; el jamming ya no es un control abstracto sino que se modela con **fuentes de interferencia posicionadas en el mapa** (un jammer terrestre encubierto y un avión jammer que patrulla en círculos sobre el teatro): la interferencia efectiva depende de la distancia real entre el UAV y la fuente activa, no de un slider desconectado de la física del escenario.
