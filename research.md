...
- **Comunicaciones resilientes multicanal con degradación y restauración simulada** (RF/óptico/satelital), pensadas para responder al escenario de jamming/interferencia de las secciones 1 y 2.
- **Detección por consistencia cruzada de sensores**: `CANAnomalyDetector` compara la velocidad reportada por CAN contra GPS e IMU, exactamente el mecanismo descrito en las secciones 4 y 5 para separar una lectura manipulada de la realidad física del vehículo.
